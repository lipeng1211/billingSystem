...
/**
 * 
 * @TableName huangguan_yuetui_daima
 */
@TableName(value ="huangguan_yuetui_daima")
@Data
public class HuangguanYuetuiDaima implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        HuangguanYuetuiDaima other = (HuangguanYuetuiDaima) that;
